...
function Projects() {
  return (
    <>
    <div className='bg-[#F0EFEE] flex flex-col max-sm:p-6 max-sm:text-xs p-9 font-regular rounded-b-[6rem] max-sm:rounded-b-[2rem]'>
         <Link to={'/'}>
            <i class="fa-solid fa-arrow-left bg-black text-white px-4 py-2 rounded-md ml-5 mt-4 cursor-pointer"></i>
        </Link>
        <div className=' flex flex-col items-center justify-center'>
            <h2 className=' border border-black max-sm:px-3 max-sm:py-1  px-6 py-3 font-medium'> My Projects</h2>
        </div>
    </div>

    <div className='flex flex-row flex-wrap justify-between gap-4 px-12 mt-20'>
        
        <div className='max-sm:w-full w-fit bg-[#F0EFEE] flex flex-col p-10 max-sm:p-10 gap-4 rounded-lg '>
            <h2 className='text-xl max-sm:text-base  font-medium'>Currency Converter</h2>
            <p className='max-sm:text-xs text-base w-60 max-sm:w-full'>A currency converter web app is a utility available via a web browser enabling users to convert values between many currencies. </p>
            <div className='mt-4 flex items-center justify-center'>
                <Link className='bg-black text-white px-4 py-2 max-sm:px-3 max-sm:py-2 max-sm:text-xs max-sm:rounded-md' to={"/projects/currency-converter"}>Visit Now  <i class="fa-solid fa-circle-arrow-up"></i></Link>
            </div>
        </div>
        ...
        <div className='max-sm:w-full w-fit bg-[#F0EFEE] flex flex-col p-10 max-sm:p-10 gap-4 rounded-lg '>
            ...
            <div className='mt-4 flex items-center justify-center'>
                <Link className='bg-black text-white px-4 py-2 max-sm:px-3 max-sm:py-2 max-sm:text-xs max-sm:rounded-md'>Building <i class="fa-solid fa-industry"></i></Link>
            </div>
        </div>
