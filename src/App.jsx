     ...
     <div className=" bg-[#F0EFEE] dark:bg-slate-900 dark:text-white flex flex-col p-9 font-regular rounded-b-[6rem] max-sm:rounded-b-[2rem]">
      <div className="flex items-center w-full justify-between visible max-sm:invisible">
         <div className=" flex gap-3 items-center">
          ...
          <button className="px-2 py-1 dark:bg-gray-800 bg-white text-xs rounded-md" onClick={(e)=>{
        ...
        <div className="flex text-xs items-center gap-4">
          ...
          <label className="inline-flex items-center cursor-pointer">
            <input type="checkbox" value="" checked={theme==="dark"} onChange={toggleTheme} className="sr-only peer"/>
            ...
            <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Dark Theme</span>
          </label>
        </div>
    ...
    <div className="mt-20 flex dark:text-white flex-col items-center">
      ...
      <div className="flex flex-col items-center mb-20">
        ...
        <div className="flex flex-row gap-4 mt-4 max-sm:mt-2">
            <button className=" flex flex-row max-sm:text-xs items-baseline w-fit gap-2 text-center justify-center cursor-pointer dark:bg-gray-900 dark:text-white dark:border-none dark:hover:bg-[#DD4B3E] bg-white text-black hover:bg-[#DD4B3E] hover:text-white border  px-4 py-2 rounded-full" onClick={(e)=>{
              e.preventDefault();
              e.stopPropagation();
              window.navigator.clipboard.writeText("mohantysourav656@gmail.com")
            }}>
          ...
          <NavLink to="/projects">My Projects <i className="fa-solid fa-code"></i></NavLink>
        </button>
        </div>
      ...
      <div className="flex items-center flex-wrap-reverse max-sm:text-center justify-between max-sm:justify-center max-sm:gap-2 max-sm:text-sm w-full px-20 mt-9 pb-9">
        ...
        <label class="inline-flex  items-center cursor-pointer">
          <input type="checkbox" checked={theme==="dark"} onChange={toggleTheme} value="" class="sr-only peer"/>
          <div class="relative w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#F0EFEE] dark:peer-focus:ring-slate-700 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-slate-600"></div>
